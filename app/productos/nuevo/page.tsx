...
const UNIDADES = ["lt/ha", "kg/ha", "ml/ha", "g/ha", "g/100lt", "ml/100lt", "cc/100lt", "lt/100lt"];
          ...
          <section style={section}>
            ...
            <div style={grid2}>
              ...
              <Field label="Ingrediente activo">
                <input value={ia} onChange={(e) => setIa(e.target.value)} style={inputStyle} placeholder="Ej. Difenoconazol 25%" />
              </Field>
