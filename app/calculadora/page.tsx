...
function CalculadoraContent() {
  ...
  const productosFiltrados = productos.filter(p => stockMap.has(p.id));
          ...
          <div style={col}>
            ...
            <div style={card}>
              ...
              {productosFiltrados.length === 0 ? (
                <p style={infoMsg}>Sin productos con stock en bodega para esta empresa.</p>
              ) : (
                <>
                  <div style={{ marginBottom: "10px" }}>
                    ...
                    {productoId && (() => {
                      ...
                      const prod  = productos.find(p => p.id === productoId);
                      return (
                        <span style={{ fontSize: "11px", color: "#15803d", fontWeight: 700, marginTop: "4px", display: "block" }}>
              ...
              <>
                ...
                <div style={{
                  ...
                  <h2 style={{ ...sectionTitle, color: resultado.suficiente ? "#15803d" : "#dc2626" }}>
                    {resultado.suficiente ? "✓ Stock suficiente" : "⚠️ Stock insuficiente"}
                  </h2>
...
const infoMsg: React.CSSProperties          = { fontSize: "13px", color: "#92400e", background: "#fffbeb", border: "1px solid #fcd34d", borderRadius: "8px", padding: "8px 12px" };
